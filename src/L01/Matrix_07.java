...
public class Matrix_07 {
    ...
    public static void main(String[] args) {
        ...
        int[][] matrix1 = new int[][]{new int[]{1, 1, 1}, new int[]{1, 1, 1}};

        // matrix1 -  כתובת של הסיבית הראשונה שממנה ועד 63 כתובות קדימה שוכנת כתובת אחרת

        int[][][] matrix3D = {new int[][]{{1, 1, 1},{2,2,2}}, new int[][]{{1, 1, 1},{2,2,2}}};
